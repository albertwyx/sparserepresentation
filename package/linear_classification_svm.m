function linear_classification_svm(tr_max_fea,tr_label,ts_max_fea,ts_label,resultmaxpathspm,lambda)

[tr_max_fea, minvalue, maxvalue] = scaletrain(tr_max_fea, 'power');
clabel = unique(tr_label);
nclass = length(clabel);
fprintf('begin svm train\n');
[w,class_name] = li2nsvm_multiclass_lbfgs(tr_max_fea', tr_label, lambda);
